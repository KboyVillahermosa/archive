        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-md rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('research-document.store') }}" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        
                        <!-- Project Name -->
                        <div>
                            <label for="project_name" class="block font-medium text-sm text-gray-700">Project Name</label>
                            <input 
                                type="text" 
                                name="project_name" 
                                id="project_name" 
